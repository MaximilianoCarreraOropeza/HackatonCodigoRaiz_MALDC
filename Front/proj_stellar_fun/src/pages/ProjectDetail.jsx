...
El proyecto busca crear una economía circular donde las acciones sostenibles sean recompensadas tangiblemente, incentivando un cambio de comportamiento a gran escala.`,
  ...
  const handleInvest = async () => {
    ...
    try {
      ...
      alert(
        "Error al procesar la inversión. Asegúrate de tener tu wallet conectado y fondos suficientes."
      );
      console.error(error);
    } finally {
      setInvesting(false);
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 rounded-2xl bg-primary/10 border border-primary/30">
                  ...
                  <i class="fa-solid fa-link"></i>  Información Blockchain
                  </h3>
                ...
                <div className="p-6 rounded-2xl bg-card border border-border space-y-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      <div className="text-3xl font-bold text-primary mb-1">
                        {project.raised.toLocaleString()} XLM
                      </div>
                      <div className="text-foreground/60">
                        de {project.goal.toLocaleString()} XLM objetivo
                      </div>
                    </div>
                  ...
                  <div className="space-y-4 pt-4 border-t border-border">
                    ...
                    >
                      {investing ? (
                        ...
                        <p>
                          Invertir ahora <i class="fa-solid fa-rocket"></i>
                        </p>
                      )}
                    </button>
                  ...
                  <div className="p-4 rounded-lg bg-accent/10 border border-accent/30">
                    <div className="flex gap-2 mb-2">
                      <span className="text-xl"><i class="fa-solid fa-gift"></i></span>
                      <h4 className="font-semibold text-foreground">
                        Recompensas
                      </h4>
                    </div>
                    <p className="text-sm text-foreground/70">
                      Los inversores recibirán tokens de equity cuando el
                      proyecto alcance su objetivo de funding.
                    </p>
                  </div>
                </div>
              </div>
